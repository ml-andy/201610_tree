...
function submitAdd(method){
  ...
  document.form1.action="product_DbAction.do";
...
<form id="form1" name="form1" method="post" action="product_DbAction.do">
...
<tr>
	<td>
		<table border="1" width="100%" bordercolorlight="#EBEBEB" cellspacing="0" cellpadding="0" bordercolordark="#C0C0C0">
		     <tr>
				...
				<tr>
      			       		...
      			       		<td class="QueryTable_SubTitle">產品名稱</td>
      			       		<td class="QueryTable_Content">
      			       		<input name="productname" value="<c:out value="${product_DbForm.productname}"/>" type="text" size="30" maxlength="70">
      			       		</td>
        			</tr>
         			...
         			<tr>
            				<td colspan="3"></td>
            				<td>
                			<input class="form_btn3" type="button" name="Submit" value="查詢" onClick="submitAdd('queryExect');">
                			<input class="form_btn3" type="button" name="Submit" value="新增" onClick="submitAdd('addInit');">
                			<!--
                			<input class="form_btn3" type="button" name="Submit" value="上傳檔案" onClick="submitAdd('uploadInit');">
                  			-->
                  			</td>
        			</tr>
      				</table>
      ...
      <!--/table: MainForm--></td>
          ...
          <!--table: QueryForm-->
         <logic:present name="Product_DbActionList" scope="session">
         <tr>
         	<td>
         	<table id="pageTable"   width=100%>
			     ...
			     <c:forEach items="${Product_DbActionList}" var="result" varStatus="status">
			       ...
			       <tr class="<c:out value="${rowClass}"/>" id="showPage" bordercolor="#FFFFFF" >
			          <td><input type="checkbox" name="delid" value="${result.id}"></td>
			           ...
			           <TD align="center">
			           <c:out value="${result.productcontent}"/>
			           </TD>
			           
			          
			          
			           <TD  align="center">
			            <input type="button" value="修改" onClick="submitupd('<c:out value="${status.index}"/>','updInit');">
			            <input type="button" value="刪除" onClick="submitupd('<c:out value="${status.index}"/>','delInit');">
			           </TD>
			       </tr>
			      </c:forEach>
			      <tr><td align="center"><input id="btn_del" name="btn_del" type="button" value="勾選刪除" /></td></tr>
		</table>
		</td>
         </tr>
